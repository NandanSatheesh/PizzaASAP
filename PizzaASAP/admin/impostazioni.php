        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
            ...
            <div class="navbar-collapse collapse justify-content-stretch" id="navbarCollapse">
                <ul class="navbar-nav ml-auto">
                  ...
                  <li>
                    <a class="nav-link active" href="impostazioni.php">Impostazioni  <span class="fas fa-wrench"></span></a>
                </li>
                <li class="nav-item">
                      ...
                      <div class="container-fluid">
                                <form id="info-account-form" action="impostazioni.php" method="post">
                                    ...
                                    <div class="row newline">
                                        ...
                                        <div class="col-md-8">
                                            <input type="password" class="form-control" name="old-pw" id="old-pw" placeholder="">
                                        </div>
                                    </div>
                                    <div class="row newline">
                                        <div class="col-md-4">
